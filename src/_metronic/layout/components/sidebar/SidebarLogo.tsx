  ...
  return (
    <div className="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
      <Link to="/dashboard">
        {config.layoutType === "dark-sidebar" ? (
          ...
          <>
            {/* <img
              ...
              className="h-30px w-70px app-sidebar-logo-default theme-light-show"
            /> */}
            {/* <img
              alt="Logo"
              src={toAbsoluteUrl("/media/logos/logo.png")}
              className="h-30px w-70px app-sidebar-logo-default theme-dark-show"
            /> */}
            <div className="logo-name app-sidebar-logo-default">
              recruitment
            </div>
          </>
        )}
        ...
        /> */}
        <div className="logo-name app-sidebar-logo-minimize">r</div>
      </Link>
