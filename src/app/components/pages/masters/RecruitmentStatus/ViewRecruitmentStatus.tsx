...
import { fetchAllRecruitmentStatus } from '../../../../reducers/mastersReducers/mastersAction';
import { connect } from 'react-redux';
import { ADD_RECRUITMENT_STATUS } from '../../../../helpers/routesConstant';
...
const ViewRecruitmentStatus = ({ getData, listRes, listLoading }: Props) => {
	...
	const filteredList =
		...
		listRes.filter((list: any) => {
			const name = list.recruitment_status.toLowerCase();
			return name.includes(searchValue.toLowerCase());
		});
	const columnsArr = ['id', 'recruitment status', 'status', 'action'];
				...
				<div className="card-header border-0 pt-6 flex-nowrap">
					...
					<div className="card-toolbar">
						...
						<button
							...
							onClick={() => navigate(ADD_RECRUITMENT_STATUS)}
						>
							<KTSVG
											...
											<tr key={index}>
												...
												<td>
													...
													<span
														...
														onClick={() =>
															navigate(`${ADD_RECRUITMENT_STATUS}/${list.id}`)
														}
													>
														<KTSVG
...
const mapStateToProps = (state: any) => {
	return {
		listRes: state.getAllRecruitmentStatusReducer.data,
		listLoading: state.getAllRecruitmentStatusReducer.loading,
		listErr: state.getAllRecruitmentStatusReducer.error,
	};
};

const mapDispatchToProps = (dispatch: any) => {
	return {
		getData: () => dispatch(fetchAllRecruitmentStatus()),
	};
};
