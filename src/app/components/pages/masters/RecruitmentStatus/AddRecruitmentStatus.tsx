...
import { VIEW_RECRUITMENT_STATUS } from "../../../../helpers/routesConstant";
      ...
      <div className="card mb-5 mb-xl-10">
        <div className="card-header border-0 align-items-center">
          <div className="card-title m-0">
            <h3 className="fw-bolder m-0">Add Recruitment Status</h3>
          </div>
        </div>
        {dataLoading && <Loader />}
          ...
          >
                ...
                <div className="col-lg-12">
                  ...
                  <div className="">
                    <input
                      ...
                      type="text"
                      autoComplete="off"
                      {...formik.getFieldProps("recruitment_status")}
                      className={clsx(
                      ...
                      formik.errors.recruitment_status && (
                        <div className="fv-plugins-message-container">
                          <div className="fv-help-block">
                            <span role="alert">{`${formik.errors.recruitment_status}`}</span>
                          </div>
                        </div>
                      )}
                  </div>
            ...
            <div className="card-footer d-flex justify-content-end py-6 px-9">
              <button
                ...
                onClick={() => navigate(VIEW_RECRUITMENT_STATUS)}
              >
                {DISCARD}
              </button>
              <button
...
const mapStateToProps = (state: any) => {
  return {
    dataRes: state.getRecruitmentStatusByIdReducer.data,
    dataLoading: state.getRecruitmentStatusByIdReducer.loading,
    dataErr: state.getRecruitmentStatusByIdReducer.error,
  };
};
...
const mapDispatchToProps = (dispatch: any) => {
  return {
    postData: (data: object, callback: Function) =>
      dispatch(postRecruitmentStatus(data, callback)),
    updateData: (data: object, callback: Function, id: number) =>
      dispatch(updateRecruitmentStatus(data, callback, id)),
    getDataById: (id: any) => dispatch(fetchRecruitmentStatusById(id)),
  };
};
