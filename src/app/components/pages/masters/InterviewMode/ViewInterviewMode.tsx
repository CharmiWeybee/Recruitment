...
import { fetchAllInterviewMode } from '../../../../reducers/mastersReducers/mastersAction';
import { connect } from 'react-redux';
import Loader from '../../../common/loader/Loader';
import { ADD_INTERVIEW_MODE } from '../../../../helpers/routesConstant';
...
const ViewInterviewMode = ({ getData, listRes, listLoading }: Props) => {
	...
	const filteredList =
		...
		listRes.filter((list: any) => {
			const name = list.interview_mode.toLowerCase();
			return name.includes(searchValue.toLowerCase());
		});

	const columnsArr = ['id', 'interview mode', 'status', 'action'];
