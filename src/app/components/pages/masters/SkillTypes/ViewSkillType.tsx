...
import { fetchAllSkillType } from '../../../../reducers/mastersReducers/mastersAction';
import { connect } from 'react-redux';
import Loader from '../../../common/loader/Loader';
import { ADD_SKILL_TYPE } from '../../../../helpers/routesConstant';
...
const ViewSkillType = ({ getData, listRes, listLoading }: Props) => {
	...
	const filteredList =
		...
		listRes.filter((list: any) => {
			const name = list.skill_type.toLowerCase();
			return name.includes(searchValue.toLowerCase());
		});
	const columnsArr = ['id', 'skill type', 'status', 'action'];
				...
				<div className="card-header border-0 pt-6 flex-nowrap">
					...
					<div className="card-toolbar">
						...
						<button
							...
							onClick={() => navigate(ADD_SKILL_TYPE)}
						>
							<KTSVG
											...
											<tr key={index}>
												...
												<td>
													...
													<span
														...
														onClick={() =>
															navigate(`${ADD_SKILL_TYPE}/${list.id}`)
														}
													>
														<KTSVG
...
const mapStateToProps = (state: any) => {
	return {
		listRes: state.getAllSkillTypeReducer.data,
		listLoading: state.getAllSkillTypeReducer.loading,
		listErr: state.getAllSkillTypeReducer.error,
	};
};

const mapDispatchToProps = (dispatch: any) => {
	return {
		getData: () => dispatch(fetchAllSkillType()),
	};
};

export default connect(mapStateToProps, mapDispatchToProps)(ViewSkillType);
