...
import { fetchAllModeofWork } from '../../../../reducers/mastersReducers/mastersAction';
import { connect } from 'react-redux';
import Loader from '../../../common/loader/Loader';
import { ADD_MODE_OF_WORK } from '../../../../helpers/routesConstant';
...
const ViewModeOfWork = ({ getData, listRes, listLoading }: Props) => {
	...
	const filteredList =
		...
		listRes.filter((list: any) => {
			const name = list.mode_of_work.toLowerCase();
			return name.includes(searchValue.toLowerCase());
		});

	const columnsArr = ['id', 'mode of work', 'status', 'action'];
				...
				<div className="card-header border-0 pt-6 flex-nowrap">
					...
					<div className="card-toolbar">
						...
						<button
							...
							onClick={() => navigate(ADD_MODE_OF_WORK)}
						>
							<KTSVG
											...
											<tr key={index}>
												...
												<td>
													...
													<span
														...
														onClick={() =>
															navigate(`${ADD_MODE_OF_WORK}/${list.id}`)
														}
													>
														<KTSVG
...
const mapStateToProps = (state: any) => {
	return {
		listRes: state.getAllModeofWorkReducer.data,
		listLoading: state.getAllModeofWorkReducer.loading,
		listErr: state.getAllModeofWorkReducer.error,
	};
};

const mapDispatchToProps = (dispatch: any) => {
	return {
		getData: () => dispatch(fetchAllModeofWork()),
	};
};

export default connect(mapStateToProps, mapDispatchToProps)(ViewModeOfWork);
