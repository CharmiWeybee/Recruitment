...
import { fetchAllSkill } from '../../../../reducers/mastersReducers/mastersAction';
import { connect } from 'react-redux';
import Loader from '../../../common/loader/Loader';
import { ADD_SKILL } from '../../../../helpers/routesConstant';
...
const ViewSkill = ({ getData, listRes, listLoading }: Props) => {
	...
	const filteredList =
		...
		listRes.filter((list: any) => {
			const name = list.skill.toLowerCase();
			return name.includes(searchValue.toLowerCase());
		});
	const columnsArr = ['id', 'skill', 'skilltype', 'status'];
											...
											<tr key={index}>
												...
												<td>
													...
													<span
														...
														onClick={() => navigate(`${ADD_SKILL}/${list.id}`)}
													>
														<KTSVG
...
const mapStateToProps = (state: any) => {
	return {
		listRes: state.getAllSkillReducer.data,
		listLoading: state.getAllSkillReducer.loading,
		listErr: state.getAllSkillReducer.error,
	};
};

const mapDispatchToProps = (dispatch: any) => {
	return {
		getData: () => dispatch(fetchAllSkill()),
	};
};

export default connect(mapStateToProps, mapDispatchToProps)(ViewSkill);
